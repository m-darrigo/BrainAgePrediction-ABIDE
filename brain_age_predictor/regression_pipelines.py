...
focused on linear regression with L1 regularization (:py:obj:`Lasso <sklearn.linear_model.Lasso>`)
...
def linear_regressor_pipeline(
    ...
    **kwargs,
    ...
    """
    Conducts a linear regression pipeline using L1 regularization
    (:py:obj:`Lasso <sklearn.linear_model.Lasso>`).
    ...
    thresh_overfit : float (default=0.05)
    ...
    **kwargs : Additional keyword arguments
        ...
        :py:obj:`GridSearchCV <sklearn.model_selection.GridSearchCV>` function.
    ...
    Note
    ----
    This function implements a linear regression pipeline with L1 regularization
    (:py:obj:`Lasso <sklearn.linear_model.Lasso>`).
    It scales the input data, performs principal component analysis
    (:py:obj:`PCA <sklearn.decomposition.PCA>`) for dimensionality
    reduction, and uses (:py:obj:`Lasso <sklearn.linear_model.Lasso>`) regression as
    the final model. The pipeline is optimized using grid search
...
def neural_network_pipeline(
    ...
    **kwargs : Additional keyword arguments
        Additional parameters to be passed to the
        :py:obj:`RandomizedSearchCV <sklearn.model_selection.RandomizedSearchCV>`
        function.
